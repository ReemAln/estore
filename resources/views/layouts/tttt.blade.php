...
<html lang="en">
 ...
 <head>
   ...
   <meta charset="utf-8">
    ...
    <link href="http://localhost:8000/css/owl.carousel.min.css" rel="stylesheet">
    <link href="http://localhost:8000/css/lightbox.min.css" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="http://localhost:8000/about" class="nav-item nav-link">About</a>
                <a href="service.html" class="nav-item nav-link">Service</a>
                <a href="http://localhost:8000/products" class="nav-item nav-link">Products</a>
               
                                  <a href="http://localhost:8000/login" class="nav-item nav-link">Log in</a>
                                          <a href="http://localhost:8000/register" class="nav-item nav-link">Register</a>
                ...
                <div class="col-lg-6 text-center text-lg-start">
                    ...
                    <a href="" class="btn btn-light py-sm-3 px-sm-5 rounded-pill me-3 animated slideInLeft">Free Quote</a>
                                            ...
                                            <a href="http://localhost:8000/login" class="text-sm text-gray-700 dark:text-gray-500 underline">Log in</a>
                                                    ...
                                                    <a href="http://localhost:8000/register" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Register</a>
...
<!-- Footer Start -->
        ...
        <!-- Footer End --><a href="#" class="btn btn-lg btn-primary btn-lg-square back-to-top pt-2"><i class="bi bi-arrow-up"></i></a>
</div>  
<!-- JavaScript Libraries -->
        ...
        <script src="http://localhost:8000/js/wow.min.js" ></script>
        <script src="http://localhost:8000/js/easing.min.js" ></script>
        <script src="http://localhost:8000/js/waypoints.min.js" ></script>
        <script src="http://localhost:8000/js/owl.carousel.min.js" ></script>
        <script src="http://localhost:8000/js/isotope.pkgd.min.js" ></script>
        <script src="http://localhost:8000/js/lightbox.min.js" ></script>


    
        <!-- Template Javascript -->
        <script src="http://localhost:8000/js/mainjs.js" ></script> 
